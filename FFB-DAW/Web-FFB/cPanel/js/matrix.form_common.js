...
$(document).ready(function () {
    ...
    $("#mask-date-2").mask("99/99/9999");
    $("#mask-date-3").mask("99/99/9999");
    ...
    $('textarea.tinymce').tinymce({
        ...
        script_url: 'plugins/forms/tiny_mce/tiny_mce.js', // General options
        theme: "advanced"
        , plugins: "autolink,lists,pagebreak,style,layer,table,save,advhr,advimage,advlink,emotions,iespell,inlinepopups,insertdatetime,preview,media,searchreplace,print,contextmenu,paste,directionality,fullscreen,noneditable,visualchars,nonbreaking,xhtmlxtras,template,advlist", // Theme options
        ...
        content_css: "css/main.css", // Drop lists for link/image/media/template dialogs
